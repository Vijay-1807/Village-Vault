...
const Sidebar = ({ isMobileOpen, onMobileClose }: { isMobileOpen?: boolean, onMobileClose?: () => void }) => {
  ...
  const navigation = [
    ...
    { name: 'Health Check', href: '/health-check', icon: Heart },
              ...
              {navigation.map((item) => {
                ...
                return (
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `group relative flex items-center justify-center px-4 py-3.5 text-sm font-medium rounded-2xl transition-all duration-200 ease-in-out ${isActive
                  ...
                  >
                    {({ isActive }) => (
                      <>
                        <div className={`flex items-center justify-center w-8 h-8 rounded-xl mr-3 transition-all duration-200 ease-in-out ${isActive
                          ? 'bg-gradient-to-br from-orange-500 to-red-500 shadow-lg shadow-orange-500/25'
                          : 'bg-gray-700/50 group-hover:bg-orange-500/30'
                          }`}>
                          <Icon className={`w-4 h-4 transition-colors duration-200 ease-in-out ${isActive
                            ? 'text-white'
                            : 'text-gray-400 group-hover:text-orange-300'
                            }`} />
                        </div>
                        <span className="text-center flex-1">{item.name}</span>
                        <ChevronRight className={`w-4 h-4 ml-3 transition-all duration-200 ease-in-out ${isActive
          ...
          <div className="flex-shrink-0 border-t border-orange-500/10 p-6">
            <div className="flex items-center space-x-4">
              <NavLink
                ...
                onClick={handleNavClick}
                className={({ isActive }) =>
                  `group flex items-center flex-1 min-w-0 space-x-4 rounded-xl p-2 -m-2 transition-all duration-200 ease-in-out ${isActive
                ...
                {navigation.map((item) => {
                  ...
                  return (
                    <NavLink
                      ...
                      onClick={handleNavClick}
                      className={({ isActive }) =>
                        `group relative flex items-center px-4 py-3.5 text-sm font-medium rounded-2xl transition-all duration-200 ease-in-out ${isActive
                          ? 'bg-gradient-to-r from-orange-500/20 to-red-500/20 text-orange-400 border border-orange-500/30 shadow-lg shadow-orange-500/10'
                          : 'text-gray-300 hover:bg-orange-500/10 hover:text-orange-300 hover:border-orange-500/30'
                        }`
                      }
                    >
                      {({ isActive }) => (
                        <>
                          <div className={`flex items-center justify-center w-8 h-8 rounded-xl mr-4 transition-all duration-200 ease-in-out ${isActive
                            ? 'bg-gradient-to-br from-orange-500 to-red-500 shadow-lg shadow-orange-500/25'
                            : 'bg-gray-700/50 group-hover:bg-orange-500/30'
                            }`}>
                            <Icon className={`w-4 h-4 transition-colors duration-200 ease-in-out ${isActive
                          ...
                          <ChevronRight className={`w-4 h-4 transition-all duration-200 ease-in-out ${isActive
                            ? 'text-orange-400 translate-x-0'
                            : 'text-gray-500 -translate-x-2 group-hover:translate-x-0 group-hover:text-orange-300'
                            }`} />
                        </>
