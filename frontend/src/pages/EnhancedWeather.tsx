          ...
          <CardContent className="p-3 md:p-4 space-y-3 md:space-y-4">
            ...
            <div className="flex flex-wrap gap-2 p-1 bg-gray-50 rounded-lg">
              <button
                ...
                className={`px-3 py-2 text-xs md:text-sm rounded-lg transition-all duration-200 flex items-center gap-1.5 font-medium ${inputType === 'auto'
              ...
              <button
                ...
                className={`px-3 py-2 text-xs md:text-sm rounded-lg transition-all duration-200 font-medium ${inputType === 'pincode'
                    ? 'bg-orange-500 text-white shadow-md scale-105'
                    : 'bg-white text-gray-700 hover:bg-gray-100 hover:scale-102'
                  }`}
              >
              ...
              <button
                ...
                className={`px-3 py-2 text-xs md:text-sm rounded-lg transition-all duration-200 flex items-center gap-1.5 font-medium ${inputType === 'city'
                    ? 'bg-orange-500 text-white shadow-md scale-105'
                    : 'bg-white text-gray-700 hover:bg-gray-100 hover:scale-102'
                  }`}
              >
              ...
              <button
                ...
                className={`px-3 py-2 text-xs md:text-sm rounded-lg transition-all duration-200 font-medium ${inputType === 'coordinates'
                    ? 'bg-orange-500 text-white shadow-md scale-105'
                    : 'bg-white text-gray-700 hover:bg-gray-100 hover:scale-102'
                  }`}
              >
